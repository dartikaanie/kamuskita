...
import static com.anie.dara.kamuskita.KamusActivity.cari;

public class DoengFragment extends Fragment implements KamusAdapter.OnKlikKeyword {
    RecyclerView rvKamus;
    KamusAdapter kamusAdapter;
    DoengHelper kamusHelper;
    Activity activity;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_doeng, container, false);

        kamusHelper = new DoengHelper(activity);
        kamusHelper.open();
